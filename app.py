...
@app.route("/retino", methods=["GET","POST"])
def retinoPage():
    return render_template('retinopathy.html')

@app.route("/retinopredict", methods = ['POST', 'GET'])
def retinopredictPage():
    if request.method == 'POST':
        ...
        new_model = tf.keras.models.load_model("models/model.model")
        ...
        if per==1:
            ...
            pred = 1
            print('DR')
    return render_template('retino_predict.html', pred=pred)
